...
public class AlbumRepository {
    ...
    public List<Map<String, Object>> selecionarAlbumPorAlbumId(int albumId) {
        return conexaoBanco.select(NOME_TABELA, "id", albumId);
    }

    public List<Map<String, Object>> selecionarAlbumPorArtistaId(int artistaId) {
